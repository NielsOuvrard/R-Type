...
void Player::send()
{
    ...
    _dataGame.channel.sendGroup(RType::message::addComponent(_entity->getId(), "Interpolation", new Haze::InterpolationData{_engine.getFramerate()}, sizeof(Haze::InterpolationData)));
